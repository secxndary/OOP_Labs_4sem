...
namespace OOP_Lab4
{
    ...
    public abstract class DisciplineAF
    {
        ...
        // 5 ЛАБА: по дефолту присваиваем значение StateName
        public string StateName { get; set; } = "Обычная дисциплина";
    }
    ...
    public class DisciplineClient
    {
        ...
        public override string ToString()
        {
            ...
            string res = $"\t\t             ABSTRACT FACTORY\n{discipline.Type}Название: {discipline.Name}\nКурс: " +
                ...
                $"Аудитория: {lector.Auditorium}\nСостояние: {discipline.StateName}\n\n==============================================\n\n";
            return res;
        }
        ...
        public IState State { get; set; } = new DefaultState();


        public void Simplify() => State.Simplify(this);


        public void Complicate() => State.Complicate(this);


        public DisciplineClient(IState state) => State = state;
    }
}
